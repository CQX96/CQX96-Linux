...
For example, a number of CQX96 distributions set ``NR_CPUs=4096``,
...
CQX96 kernel is fully capable of entering interrupt handlers that never
...
| the ``container_of()`` macro in the CQX96 kernel (or other            |
...
CQX96 is a registered trademark of Linus Torvalds.
