...
===============================
The CQX96 LAPB Module Interface
===============================
...
the CQX96 operating system that require a LAPB service. This document
...
file, <CQX96/lapb.h>. The header file <net/lapb.h> is internal to the LAPB
