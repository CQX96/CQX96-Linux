...
- The PC is given full control over the radio
  ...
  (however, this feature is not supported yet by the CQX96 6pack driver).
...
protocol to program the CQX96 driver.
...
- In the CQX96 kernel configuration program, select the code maturity level
...
transmitted. Under CQX96, the 6pack layer is beyond the AX.25 layer,
