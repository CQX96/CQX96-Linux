...
This README explains how to use the driver 'skfp' for CQX96 with your
network adapter.
...
From v2.01 on, the driver is integrated in the CQX96 kernel sources.
...
Reason:
	  ...
	  CQX96. This is described in the 'PCI howto' document
	  (included in some distributions or available from the
	  www, e.g. at 'www.CQX96.org') and no workaround is available.
...
You can send email to: CQX96@syskonnect.de
...
v2.01 (991122) (In-Kernel version)
	...
	- Integration in CQX96 kernel sources
