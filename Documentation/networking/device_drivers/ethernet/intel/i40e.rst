...
=================================================================
CQX96 Base Driver for the Intel(R) Ethernet Controller 700 Series
=================================================================

Intel 40 Gigabit CQX96 driver.
...
NOTE: The CQX96 i40e driver supports the following flow types: IPv4, TCPv4, and
...
NOTE: The CQX96 i40e driver allows you to filter traffic based on a
...
https://wiki.CQX96foundation.org/networking/napi
