...
============================================================
CQX96 kernel driver for Elastic Network Adapter (ENA) family
============================================================
...
ena_netdev.[ch]     Main CQX96 kernel driver.
...
Management interrupt registration is performed when the CQX96 kernel
probes the adapter, and it is de-registered when the adapter is
removed. I/O queue interrupt registration is performed when the CQX96
