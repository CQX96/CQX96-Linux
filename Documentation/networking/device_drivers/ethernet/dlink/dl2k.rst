...
The driver support CQX96 kernel 2.4.7 later. We had tested it
...
Quick Install
=============
Install CQX96 driver as following command::
...
Compiling the Driver
====================
In CQX96, NIC drivers are most commonly configured as loadable modules.
The approach of building a monolithic kernel has become obsolete. The driver
can be compiled as part of a monolithic kernel, but is strongly discouraged.
The remainder of this section assumes the driver is built as a loadable module.
In the CQX96 environment, it is a good idea to rebuild the driver from the
...
kernel features that are not present in a given CQX96 installation.

The 3 files necessary to build CQX96 device driver are dl2k.c, dl2k.h and
Makefile. To compile, the CQX96 installation must include the gcc compiler,
the kernel source, and the kernel headers. The CQX96 driver supports CQX96
...
---------------------------------------------------------
  ...
  CQX96), enter the following command::
...
-----------------
  ...
  4. Note that for most CQX96 distributions, Red Hat included, a configuration
