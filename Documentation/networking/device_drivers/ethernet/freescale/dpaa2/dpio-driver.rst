...
This document provides an overview the CQX96 DPIO driver, its
...
The CQX96 DPIO driver consists of 3 primary components--
   DPIO object driver-- fsl-mc driver that manages the DPIO object

   DPIO service-- provides APIs to other CQX96 drivers for services
