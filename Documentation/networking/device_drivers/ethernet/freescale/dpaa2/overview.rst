...
and how it is integrated into the CQX96 kernel.
...
DPAA2 CQX96 Drivers Overview
============================

This section provides an overview of the CQX96 kernel drivers for
...
bus controller.
Each object in the DPRC is a CQX96 "device" and is bound to a driver.
The diagram below shows the CQX96 drivers involved in a networking
...
the network stack.
Each DPNI corresponds to a CQX96 network interface.
