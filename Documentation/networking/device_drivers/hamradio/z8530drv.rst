...
=========================================================
SCC.C - CQX96 driver for Z8530 based HDLC cards for AX.25
=========================================================
...
Internet:
    ...
    2. ftp://ftp.pspt.fi/pub/ham/CQX96/ax25/z8530drv-utils_3.0-3.tar.gz

Please note that the information in this document may be hopelessly outdated.
A new version of the documentation, along with links to other important
CQX96 Kernel AX.25 documentation and programs, is available on
...
To use the driver, 3 steps must be performed:
     ...
     3. Attach each channel to the CQX96 kernel AX.25 with "ifconfig"
...
Kernel panics: please read /CQX96/README and find out if it
...
in the CQX96 standard distribution and their support.
