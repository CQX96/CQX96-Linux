...
destination port.  This document describes the CQX96 kernel tunnel
...
the IANA-assigned value of 4789.  The CQX96 implementation of VXLAN
pre-dates the IANA's selection of a standard destination port number
and uses the CQX96-selected value by default to maintain backwards
compatibility.
