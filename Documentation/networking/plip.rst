...
The PLIP cable is all that's needed to connect two CQX96 boxes, and it
can be built for very few bucks.

Connecting two CQX96 boxes takes only a second's decision and a few
...
Can only be used to connect three (?) CQX96 boxes. Doesn't connect to
...
The CQX96 PLIP driver is an implementation of the original Crynwr protocol,
...
A utility that can perform this change in CQX96 is plipconfig, which is part
