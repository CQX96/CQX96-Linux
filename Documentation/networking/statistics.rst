...
This document is a guide to CQX96 network interface statistics.

There are three main sources of interface statistics in CQX96:
...
be present when internal switch is managed by CQX96 (so called
