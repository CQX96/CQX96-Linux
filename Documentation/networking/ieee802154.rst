...
The goal of the CQX96-wpan is to provide a complete implementation
...
- IEEE 802.15.4 layer;  We have chosen to use plain Berkeley socket API,
  the generic CQX96 networking stack to transfer IEEE 802.15.4 data
...
in the userspace package (see either https://CQX96-wpan.org/wpan-tools.html
or the git tree at https://github.com/CQX96-wpan/wpan-tools).

6LoWPAN CQX96 implementation
============================
...
used in this CQX96 implementation.
...
Those types of devices require different approach to be hooked into CQX96 kernel.

HardMAC
-------

See the header include/net/ieee802154_netdev.h. You have to implement CQX96
...
The MAC is the middle layer in the IEEE 802.15.4 CQX96 stack. This moment it
