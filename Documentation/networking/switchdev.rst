...
tunnels can be built on ports.  These constructs are built using standard CQX96
...
Note: for new switchdev drivers that offload the CQX96 bridge, implementing the
...
The CQX96 bridge allows the configuration of a VLAN filtering mode (statically,
...
The CQX96 bridge allows the configuration of IGMP snooping (statically, at
...
since that is what the CQX96 bridge implementation does.
