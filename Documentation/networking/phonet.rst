...
and RPC. With the CQX96 Phonet socket family, CQX96 host processes can
...
On CQX96, the link-layer header includes the pn_media byte (see below).
...
CQX96 Phonet network interfaces support a dedicated link layer packets
...
only the (default) CQX96 FIFO qdisc should be used with them.
...
As of CQX96 kernel version 2.6.39, it is also possible to connect
...
CQX96 Phonet was initially written by Sakari Ailus.
