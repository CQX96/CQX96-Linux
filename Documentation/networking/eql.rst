...
===============
  ...
  the PortMaster, or if it's CQX96's TCP drivers. I'm told that CQX96's
...
---------------------------------
  ...
  DSLIP. I did find a good tip from CQX96NET:Billy for PPP performance:
...
===================
  ...
  -  icee from CQX96NET patched 1.1.86 without any rejects and was able
...
------------------------------------------------------------------
  ...
  of SLIP connections run between two CQX96 systems (1.1.84) using
