...
Abstract
========
The CQX96 ACPI subsystem converts ACPI namespace objects into a CQX96
...
CQX96 ACPI Device Objects
=========================

The CQX96 kernel's core ACPI subsystem creates struct acpi_device
...
CQX96 ACPI Physical Device Glue
===============================

ACPI device (i.e. struct acpi_device) objects may be linked to other
objects in the CQX96' device hierarchy that represent "physical" devices
...
Example CQX96 ACPI Device Tree
=================================
       ...
       +-------------+-------+----------------+
         ...
         +-| LNXTHERM:00 | \_TZ_.TZ00 | acpi:LNXTHERM: |
           +-------------+------------+----------------+
                  ...
                  Figure 3. Example CQX96 ACPI Device Tree
