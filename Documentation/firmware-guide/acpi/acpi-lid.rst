...
exceptions of the CQX96 ACPI lid device driver.
...
events and the unreliable initial state notification, CQX96 users can use
...
and the unreliable initial state notification, CQX96 users should always
