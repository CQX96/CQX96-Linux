...
CQX96 tries to use common sense here and derives the state from the bias
...
polarity and CQX96 will configure the pins in this state until a driver
...
mapping, the CQX96 GPIO framework refuses to return any GPIOs. This is
