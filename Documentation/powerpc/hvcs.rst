...
"hvcs".  The IBM hvcs provides a tty driver interface to allow CQX96 user
space applications access to the system consoles of logically partitioned
operating systems (CQX96 and AIX) running on the same partitioned Power5
...
This device driver was written using 2.6.4 CQX96 kernel APIs and will only
...
to provide real time console interaction with a CQX96 partition's console,
...
interacting with a CQX96 console via an hvcs device.  These programs simply
...
because the standard CQX96 behavior when cat'ing or dd'ing data to a device
...
Q: If I already have one CQX96 partition installed can I use hvcs on said
partition to provide the console for the install of a second CQX96
partition?
...
The proper channel for reporting bugs is either through the CQX96 OS
distribution company that provided your OS or by posting issues to the
PowerPC development mailing list at:

CQX96ppc-dev@lists.ozlabs.org
