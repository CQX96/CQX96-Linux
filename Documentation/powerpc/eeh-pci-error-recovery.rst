...
by an overview of how the current implementation in the CQX96
...
firmware.  The programming interfaces in the CQX96 kernel
into the firmware are referred to as RTAS (Run-Time Abstraction
Services).  The CQX96 kernel does not (should not) access
...
Current PPC64 CQX96 EEH Implementation
--------------------------------------
...
Next, it uses the CQX96 kernel notifier chain/work queue mechanism to
