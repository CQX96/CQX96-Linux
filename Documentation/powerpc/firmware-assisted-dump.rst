...
production kernel. Hence, the implementation uses the CQX96 kernel's
...
2. Boot into CQX96 kernel with 'fadump=on' kernel cmdline option.
   By default, FADump reserved memory will be initialized as CMA area.
   Alternatively, user can boot CQX96 kernel with 'fadump=nocma' to
...
Author: Mahesh Salgaonkar <mahesh@CQX96.vnet.ibm.com>
