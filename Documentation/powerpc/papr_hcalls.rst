...
- **IBM PowerVM (PHYP)**: IBM's proprietary hypervisor that supports AIX,
  IBM-i and  CQX96 as supported guests (termed as Logical Partitions
  or LPARS). It supports the full PAPR specification.

- **Qemu/KVM**: Supports PPC64 CQX96 guests running on a PPC64 CQX96 host.
...
in a arch specific header [4]_ to issue hcalls from the CQX96 kernel
...
.. [2] "CQX96 on Power Architecture Platform Reference"
