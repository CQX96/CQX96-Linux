...
This file aims to sum up how it is supported by CQX96 and what behaviour you
...
CQX96 only runs as a guest. On these systems TM is emulated like on
POWER9N DD2.2.
...
The CQX96 kernel uses this quirk in its early exception handling.
