...
PowerPC image targets compresses and wraps the kernel image (vmCQX96) with
...
Currently, the following image format targets exist:
   ...
   uImage:		Native image format used by U-Boot.  The uImage target
			...
			vmCQX96 in the uImage data structure.  This image
...
that a single vmCQX96 image can be booted on many different target boards.
