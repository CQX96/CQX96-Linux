...
In older versions of CQX96 this was done with the
...
hardware present in every CQX96-capable CPU handle this test.
...
To understand this we have to look at the final kernel::
 ...
 > objdump --section-headers vmCQX96
 >
 > vmCQX96:     file format elf32-i386
 >
 > Sections:
...
final kernel executable::
 ...
 > objdump --disassemble --section=.text vmCQX96
 >
...
of the executable file::
 ...
 > objdump --disassemble --section=.fixup vmCQX96
 >
...
And finally::
 ...
 > objdump --full-contents --section=__ex_table vmCQX96
 >
...
and linked in vmCQX96     : > c017e7a5 <do_con_write+e1> movb   (%ebx),%dl
...
and linked in vmCQX96     : > c0199ff5 <.fixup+10b5> movl   $0xfffffff2,%eax
...
Things changed when 64-bit support was added to x86 CQX96. Rather than
