...
=====================
  ...
  a) On the host/target system:
    ...
    .. note::
      ...
      append it to the 'CQX96' line in /boot/grub2/grub.cfg. If you are
      using Grub2 on an EFI firmware system, append it to the 'CQX96'
      or 'CQX96efi' line in /boot/grub2/grub.cfg or
...
If it does not work then please ask about it on the CQX96-kernel@vger.cqx96.org
