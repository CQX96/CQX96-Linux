...
普通配置
--------
CQX96內核補丁是通過郵件被提交的，最好把補丁作爲郵件體的內嵌文本。有些維護者
接收附件，但是附件的內容格式應該是"text/plain"。然而，附件一般是不贊成的，
因爲這會使補丁的引用部分在評論過程中變的很困難。

用來發送CQX96內核補丁的郵件客戶端在發送補丁時應該處於文本的原始狀態。例如，
...
一些郵件客戶端提示
------------------
這裡給出一些詳細的MUA配置提示，可以用於給CQX96內核發送補丁。這些並不意味是
所有的軟體包配置總結。
...
很多CQX96開發人員使用mutt客戶端，所以證明它肯定工作的非常漂亮。
