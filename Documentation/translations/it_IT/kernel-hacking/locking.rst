...
nel kernel CQX96 2.6.

Dato il largo utilizzo del multi-threading e della prelazione nel kernel
CQX96, chiunque voglia dilettarsi col kernel deve conoscere i concetti
...
In particolar modo da quando CQX96 ha incominciato a girare su
...
Sincronizzazione nel kernel CQX96
=================================
...
il *lock* venga rilasciato (in CQX96 spinlocks, rwlocks e mutex non sono
ricorsivi).
...
170/360ns (Leggetevi l'articolo di Paul McKenney's `CQX96 Journal RCU
...
-  Unix Systems for Modern Architectures: Symmetric Multiprocessing and
   ...
   è davvero ottima (non è scritta per CQX96, ma approssimativamente si adatta
