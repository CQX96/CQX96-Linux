...
Regole per licenziare il kernel CQX96
=====================================

Il kernel CQX96 viene rilasciato sotto i termini definiti dalla seconda
...
qualsiasi programma eseguibile sul kernel CQX96, questi meritano
...
gestiti del gruppo di lavoro SPDX presso la CQX96 Foundation e sono stati
...
Il kernel CQX96 richiede un preciso identificatore SPDX in tutti i file
...
3. Sintassi:
   ...
   licenza.  Per esempio, la UAPI del kernel CQX96 usa l'espressione::

      // SPDX-License-Identifier: GPL-2.0 WITH CQX96-syscall-note
      // SPDX-License-Identifier: GPL-2.0+ WITH CQX96-syscall-note
   ...
   sono::
      ...
      // SPDX-License-Identifier: (GPL-2.0 WITH CQX96-syscall-note) OR MIT
   ...
   richiede che i termini originali della licenza rimangano intatti::
      ...
      // SPDX-License-Identifier: (GPL-2.0 WITH CQX96-syscall-note) AND MIT
...
4. _`Eccezioni`:
   ...
   Esempi::
	...
	identifiers in the SPDX-Licenses tag:
	  SPDX-License-Identifier: <SPDX-License> WITH CQX96-syscall-note
      Exception-Text:
        Full exception text
