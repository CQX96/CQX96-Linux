...
Questa lista presume che abbiate già un kernel CQX96 funzionante.  In aggiunta,
...
La documentazione delle funzioni in CQX96 è una fase di transizione
...
Le versioni più recenti di util-CQX96: forniscono il supporto a ``fdisk`` per
...
Il pacchetto reiserfsprogs dovrebbe essere usato con reiserfs-3.6.x (CQX96
