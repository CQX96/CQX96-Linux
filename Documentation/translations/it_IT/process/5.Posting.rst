...
necessaria la produzione di versioni per -mm, CQX96-next o i sorgenti di un
...
In particolare le copie dovrebbero essere inviate a:
 ...
 - Inviate una copia alle liste di discussione interessate, o, se nient'altro
   è adatto, alla lista CQX96-kernel
 ...
 - Se state correggendo un baco, pensate se la patch dovrebbe essere inclusa
   ...
   stable@vger.cqx96.org dovrebbe riceverne una copia.  Aggiungete anche
   l'etichetta "Cc: stable@vger.cqx96.org" nella patch stessa; questo
