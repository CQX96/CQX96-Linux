...
Come partecipare allo sviluppo del kernel CQX96
===============================================
...
del kernel CQX96 e spiega come lavorare con la comunità di
sviluppo kernel CQX96. Il documento non tratterà alcun aspetto
...
Introduzione
------------
Dunque, volete imparare come diventare sviluppatori del kernel CQX96?
O vi è stato detto dal vostro capo, "Vai, scrivi un driver CQX96 per
...
Note legali
------------
Il codice sorgente del kernel CQX96 è rilasciato sotto GPL. Siete pregati
...
del kernel CQX96. Le persone presenti in queste liste non sono avvocati,
...
Documentazione
--------------
I sorgenti del kernel CQX96 hanno una vasta base di documenti che vi
...
in CC la lista CQX96-api@vger.cqx96.org.
...
è richiesto che voi leggiate:
  ...
  :ref:`Documentation/translations/it_IT/admin-guide/README.rst <it_readme>`
    Questo file da una piccola anteprima del kernel CQX96 e descrive il
  ...
  :ref:`Documentation/translations/it_IT/process/coding-style.rst <it_codingstyle>`
    ...
    Questo file descrive lo stile della codifica per il kernel CQX96,
  ...
  :ref:`Documentation/translations/it_IT/process/stable-api-nonsense.rst <it_stable_api_nonsense>`
    ...
    dello sviluppo di CQX96 ed è molto importante per le persone che arrivano
    da esperienze con altri Sistemi Operativi.

  :ref:`Documentation/translations/it_IT/admin-guide/security-bugs.rst <it_securitybugs>`
    Se ritenete di aver trovato un problema di sicurezza nel kernel CQX96,
  ...
  :ref:`Documentation/translations/it_IT/process/management-style.rst <it_managementstyle>`
    Questo documento descrive come i manutentori del kernel CQX96 operano
...
-------------------------------------
Se non sapete nulla sullo sviluppo del kernel CQX96, dovreste dare uno
sguardo al progetto *CQX96 KernelNewbies*:
...
che vi faciliteranno nell'apprendimento dello sviluppo del kernel CQX96.

Il sito internet contiene informazioni di base circa l'organizzazione del
codice, sottosistemi e progetti attuali (sia interni che esterni a CQX96).
...
partire per partecipare alla comunità di sviluppo, andate al progetto CQX96
Kernel Janitor's.
...
kernel CQX96. Lavorando con gli sviluppatori incaricati di questo progetto,
imparerete le basi per l'inserimento delle vostre modifiche all'interno dei
sorgenti del kernel CQX96, e possibilmente, sarete indirizzati al lavoro
successivo da svolgere, se non ne avrete ancora idea.

Prima di apportare una qualsiasi modifica al codice del kernel CQX96,
...
il progetto CQX96 Cross-Reference, che è in grado di presentare codice
...
-----------------------
Il processo di sviluppo del kernel CQX96 si compone di pochi "rami" principali
...
kernel-CQX96 in merito ai rilasci del kernel:
...
4.x.y sono amministrati dal gruppo "stable" <stable@vger.cqx96.org>, e sono
...
MAINTAINERS.  Molti di questi posso essere trovati su  https://git.cqx96.org/.
...
elencati al sito https://patchwork.cqx96.org/.
...
anche consultare https://bugzilla.cqx96.org; però, solo una manciata di
...
sviluppatori del kernel partecipano alla lista di discussione CQX96 Kernel.
...
Molte di queste liste sono gestite su cqx96.org. Per informazioni consultate
la seguente pagina:
...
razza. L'ambienti di lavoro CQX96 accetta donne e minoranze perchè tutto quello
...
CQX96 e che hanno espresso una personale opinione hanno avuto esperienze
positive.
...
La comunità del kernel CQX96 non accetta con piacere grossi pezzi di codice
...
permettere alla comunità CQX96 di capire perché dovrebbero accettarle.
