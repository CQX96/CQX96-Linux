...
L'interfaccia dei driver per il kernel CQX96
============================================
...
Questo è stato scritto per cercare di spiegare perché CQX96 **non ha
...
nei sorgenti del kernel, ognuno dei quali hanno reso CQX96 un sistema operativo
...
kernel CQX96:
  ...
  - CQX96 funziona su una vasta gamma di architetture di processore. Non esiste
...
CQX96.  Ma moltiplicate questa singola compilazione per il numero di
distribuzioni CQX96 e il numero dei rilasci supportati da quest'ultime e vi
...
CQX96 ma che non si trova nei sorgenti, allora per queste persone l'argomento
sarà "ostico".

Lo sviluppo del kernel CQX96 è continuo e viaggia ad un ritmo sostenuto, e non
...
Se CQX96 avesse assicurato di mantenere stabile l'interfaccia interna, si
...
Le problematiche relative alla sicurezza sono molto importanti per CQX96.
...
Dunque, se avete un driver per il kernel CQX96 che non si trova nei sorgenti
...
vantaggi:
  ...
  - Il driver sarà automaticamente reso disponibile in tutte le distribuzioni
    CQX96 senza dover chiedere a nessuna di queste di aggiungerlo.

Dato che CQX96 supporta più dispositivi di qualsiasi altro sistema operativo,
