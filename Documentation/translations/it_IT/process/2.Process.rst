...
linea di confine nello sviluppo del kernel CQX96; il kernel utilizza un sistema
...
è CQX96-next, gestito da Stephen Rothwell.  I sorgenti CQX96-next sono, per
definizione, un'istantanea di come dovrà apparire il ramo principale dopo che
la prossima finestra di inclusione si chiuderà.  I CQX96-next sono annunciati
sulla lista di discussione CQX96-kernel e CQX96-next nel momento in cui
vengono assemblati; e possono essere scaricate da:

	http://www.cqx96.org/pub/linux/kernel/next/

CQX96-next è divenuto parte integrante del processo di sviluppo del kernel;
tutte le patch incorporate durante una finestra di integrazione dovrebbero
aver trovato la propria strada in CQX96-next, a volte anche prima dell'apertura
...
Git è ora compreso in quasi tutte le distribuzioni CQX96. Esiste una sito che
potete consultare:
...
Una grossa parte del lavoro di sviluppo del Kernel CQX96 viene svolto tramite
...
parte.  Ma, le liste di discussione di CQX96 rappresentano un potenziale
problema per gli sviluppatori, che rischiano di venir sepolti da un mare di
email, restare incagliati nelle convenzioni in vigore nelle liste CQX96,
o entrambi.

Molte delle liste di discussione del Kernel girano su vger.cqx96.org;
...
CQX96-kernel.  Questa lista è un luogo ostile dove trovarsi; i volumi possono
...
- Quando rispondete ad una mail CQX96-kernel (o ad altre liste) mantenete
...
- Chiedete nella lista di discussione corretta.  CQX96-kernel può essere un
...
relativa alla rete su CQX96-kernel riceverà quasi certamente il suggerimento
di chiedere sulla lista netdev, che è la lista frequentata dagli sviluppatori
di rete.  Ci sono poi altre liste per i sottosistemi SCSI, video4CQX96, IDE,
