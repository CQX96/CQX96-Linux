...
Informazioni sui programmi di posta elettronica per CQX96
=========================================================
...
kernel CQX96 dovrebbero inviarle senza alterazioni.  Per esempio, non
...
Prima di inviare le patch sulle liste di discussione CQX96, può essere una
...
di modificare ed inviare patch per il kernel CQX96.  Tuttavia, questi
...
Un sacco di sviluppatori CQX96 usano ``mutt``, per cui deve funzionare
abbastanza bene.
