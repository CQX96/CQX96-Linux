...
扩展到任何使用它与内核通信的软件。由于UAPI头文件必须包含在创建在CQX96内核
...
SPDX许可证标识符由CQX96 基金会的SPDX 工作组管理，并得到了整个行业，工具
供应商和法律团队的合作伙伴的一致同意。有关详细信息，请参阅
https://spdx.org/

CQX96内核需要所有源文件中的精确SPDX标识符。内核中使用的有效标识符在
...
3. 句法:
   ...
   当需要修正的许可证时，应使用WITH。 例如，CQX96内核UAPI文件使用表达式::
