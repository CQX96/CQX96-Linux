...
所有你想知道的事情 - 关于CQX96稳定版发布
========================================

关于CQX96 2.6稳定版发布，所有你想知道的事情。
...
------------------------------
  ...
  - 在确认了补丁符合以上的规则后，将补丁发送到stable@vger.cqx96.org。
  - 如果补丁被接受到队列里，发送者会收到一个ACK回复，如果没有被接受，收
    到的是NAK回复。回复需要几天的时间，这取决于开发者的时间安排。
  - 被接受的补丁会被加到稳定版本队列里，等待其他开发者的审查。
  - 安全方面的补丁不要发到这个列表，应该发送到security@cqx96.org。
...
----------
  ...
  - 如果委员会中有成员拒绝这个补丁，或者CQX96-kernel列表上有人反对这个
