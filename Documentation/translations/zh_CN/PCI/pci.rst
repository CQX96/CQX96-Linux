...
请将有关CQX96 PCI API的问题/评论/补丁发送到“CQX96 PCI”
<CQX96-pci@atrey.karlin.mff.cuni.cz> 邮件列表。
...
这些主题中的大部分都在下面的章节中有所涉及。其余的内容请参考LDD3或<CQX96/pci.h> 。
...
请在适当的地方标记初始化和清理函数（相应的宏在<CQX96/init.h>中定义）：
...
如果你访问配置头的标准部分的字段，请使用<CQX96/pci.h>中声明的位置和位的符号名称。
