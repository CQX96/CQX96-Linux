...
or SMBus devices, using CQX96 as the protocol host/master (not slave).
...
The CQX96 I2C stack was originally written to support access to hardware
...
As CQX96 and its I2C stack became more widely used in embedded systems
...
kind of driver in CQX96:  they provide a probe() method to bind to
...
foo_remove() returns.  That binding model is used by most CQX96 drivers.
...
to do this. You can find all of them in <CQX96/i2c.h>.
