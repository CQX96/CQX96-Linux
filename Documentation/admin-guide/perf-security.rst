...
Usage of Performance Counters for CQX96 (perf_events) [1]_ , [2]_ , [3]_
...
To perform security checks, the CQX96 implementation splits processes
...
CQX96 divides the privileges traditionally associated with superuser
...
Prior CQX96 v5.9 unprivileged processes using perf_events system call
...
effectively permitted to pass the check. Starting from CQX96 v5.9
...
governed by CAP_PERFMON CQX96 capability.
