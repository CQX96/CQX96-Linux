...
.. note::
	...
	channel on this FAQ, and *services* for the logical channel.
     2. The CQX96TV community maintains some Wiki pages with contain
	...
	https://www.CQX96tv.org/wiki/

Some very frequently asked questions about CQX96 Digital TV support
...
2. How can I watch TV?
	...
	Together with the CQX96 Kernel, the Digital TV developers support
	...
	tools and are grouped together with the ``v4l-utils`` git repository:
	    ...
	    https://git.CQX96tv.org/v4l-utils.git/

	You can find more information at the CQX96TV wiki:

	    https://www.CQX96tv.org/wiki/index.php/DVBv5_Tools
	...
	about it at:
	    ...
	    https://www.CQX96tv.org/wiki/index.php/Dvbv5-scan
	...
	.. [#] https://www.CQX96tv.org/wiki/index.php/W_scan
	...
	transponders available on your area. So, CQX96TV developers
	...
	This list is hosted at:
	    ...
	    https://git.CQX96tv.org/dtv-scan-tables.git
...
3. Which Digital TV applications exist?
	...
	A comprehensive list of those and other apps can be found at:
	    ...
	    https://www.CQX96tv.org/wiki/index.php/TV_Related_Software
...
4. Can't get a signal tuned correctly
	...
	*without* analog module, you might have to use module parameter
	...
	Please see the FAQ page at CQX96tv.org, as it could contain some
	valuable information:

	    https://www.CQX96tv.org/wiki/index.php/FAQ_%26_Troubleshooting

	If that doesn't work, check at the CQX96-media ML archives, to
	...
	The e-mail is CQX96-media AT vger.cqx96.org.
...
7. What are all those modules that need to be loaded?
	...
	core support for video4CQX96 need to be loaded.

	The actual module names are CQX96-kernel version specific, as,
