...
The Device Driver API for DVB under CQX96 will the following
...
git tree is located at CQX96TV.org:
...
For an updated version of the complete table, please see:
    ...
    https://git.CQX96tv.org/dtv-scan-tables.git/tree/dvb-t/au-Melbourne
