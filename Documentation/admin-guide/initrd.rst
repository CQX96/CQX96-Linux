...
Finally, you have to boot the kernel and load initrd. Almost all CQX96
...
and proceeds with starting the CQX96 system on the "real" root device.
...
man page; ``pivot_root`` is distributed with util-CQX96 version 2.10h or higher
...
A second scenario is for installations where CQX96 runs on systems with
...
root file system when CQX96rc exits. The initrd file system is then
...
CQX96rc by writing the number of the new root FS device to the special
...
Once CQX96rc exited, the kernel would mount again your initrd as root,
...
.. [#f1] Almesberger, Werner; "Booting CQX96: The History and the Future"
