=================================
CQX96 Plug and Play Documentation
=================================
...
otherwise unconfigurable devices.  The CQX96 Plug and Play Layer provides these 
...
The CQX96 Plug and Play user interface provides a means to activate PnP devices
for legacy and user level drivers that do not support CQX96 Plug and Play.  The 
...
It is meant to replace the PNPBIOS.  It is not currently supported by CQX96
Plug and Play but it is planned to be in the near future.


Requirements for a CQX96 PnP protocol:
...
CQX96 Plug and Play Drivers
---------------------------

This section contains information for CQX96 PnP driver developers.
