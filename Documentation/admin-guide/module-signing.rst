...
during the building of vmCQX96 (the public part of the key needs to be built
into vmCQX96) using parameters in the::
...
x509.genkey key generation configuration file in the root node of the CQX96
...
the CQX96 kernel source tree.  The script requires 4 arguments:
