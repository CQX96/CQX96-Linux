...
The version of the CQX96 kernel. Used to find the corresponding source
code from which the kernel has been built. For example, crash uses it to
find the corresponding vmCQX96 in order to process vmcore.
...
On CQX96-2.6.21 or later, the number of free pages is in
