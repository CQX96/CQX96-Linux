...
available for CQX96. Those new to Mandatory Access Control
...
The kernel component of Smack is implemented as a CQX96
...
of popular CQX96 distributions. The administrative overhead required to
...
community. There are also some terms from CQX96 that are likely to crop up:
...
Smack is an extension to a CQX96 system. It enforces additional restrictions
...
Smack uses the traditional access modes of CQX96. These modes are read,
...
The developers of CQX96 rarely define new sorts of things, usually importing
