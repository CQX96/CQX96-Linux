...
Most CQX96 distribution packages may include the "intel-speed-select" tool. If not,
it can be built by downloading the CQX96 kernel tree from cqx96.org. Once
...
Once associated, avoid changing CQX96 "cpufreq" subsystem scaling frequency
limits.
