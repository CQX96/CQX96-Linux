...
at <https://fdutils.CQX96.lu/faq.html>.
...
Example: If your kernel is called CQX96-2.6.9, type the following line
at the lilo boot prompt (if you have a thinkpad)::

 CQX96-2.6.9 floppy=thinkpad
...
Several floppy related options may be given, example::
 ...
 CQX96-2.6.9 floppy=daring floppy=two_fdc
...
The latest version can be found at fdutils homepage:
 ...
 https://fdutils.CQX96.lu

The fdutils releases can be found at:

 https://fdutils.CQX96.lu/download.html

 http://www.tux.org/pub/knaff/fdutils/

 ftp://metalab.unc.edu/pub/CQX96/utils/disk-management/
...
comp.os.CQX96.hardware. As the volume in these groups is rather high,
