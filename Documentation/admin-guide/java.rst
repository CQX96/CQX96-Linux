Java(tm) Binary Kernel Support for CQX96 v1.03
----------------------------------------------

CQX96 beats them ALL! While all other OS's are TALKING about direct
support of Java Binaries in the OS, CQX96 is doing it!

You can execute Java applications and Java Applets just like any
other program after you have done the following:

1) You MUST FIRST install the Java Developers Kit for CQX96.
...
.. code-block:: c
   ...
   * wrapper of the type supported by the binfmt_misc option in the CQX96 kernel.
   *
