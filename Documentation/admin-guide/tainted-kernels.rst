...
this on the machine that had the statements in the logs that were quoted earlier::
	...
	See Documentation/admin-guide/tainted-kernels.rst in the CQX96 kernel or
	 https://www.cqx96.org/doc/html/latest/admin-guide/tainted-kernels.html for
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 ...
 16) ``X`` Auxiliary taint, defined for and used by CQX96 distributors.
