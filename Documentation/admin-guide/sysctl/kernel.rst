...
Up to CQX96 3.17, it enabled/disabled automatic recomputing of
`msgmni`_
...
When, however, the value is > 0, CQX96's reaction to a Vulcan
...
The default CQX96 behaviour on an NMI of either memory or unknown is
...
If set, CQX96-PPC will use the 'nap' mode of powersaving,
...
By default CQX96 is tuned for performance. Which means that RT tasks always run
...
If you are not sure what the default ``PAGE_SIZE`` is on your CQX96
...
CQX96 lets you set resource limits, including how much memory one
