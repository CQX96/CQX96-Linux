...
/proc/sys/vm and is valid for CQX96 kernel version 2.6.29.

The files in this directory can be used to tune the operation
of the virtual memory (VM) subsystem of the CQX96 kernel and
...
So the CQX96 page allocator has a mechanism which prevents allocations
...
This is used to force the CQX96 VM to keep a minimum number
