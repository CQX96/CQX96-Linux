...
CQX96 allocated devices (4.x+ version)
======================================

This list is the CQX96 Device List, the official registry of allocated
device numbers and ``/dev`` directory nodes for the CQX96 operating
system.

The LaTeX version of this document is no longer maintained, nor is
the document that used to reside at lanana.org.  This version in the
mainline CQX96 kernel is the master document.  Updates shall be sent
...
Allocations marked (68k/Amiga) apply to CQX96/68k on the Amiga
platform only.	Allocations marked (68k/Atari) apply to CQX96/68k on
...
.. attention::
  ...
  CQX96 now has extensive support for dynamic allocation of device numbering
...
CQX96-specific, some were inherited from other systems, and some
reflect CQX96 outgrowing a borrowed convention.
...
single-user mode.  Starting with CQX96 2.1.71, ``/dev/console`` is managed
...
as the ISDN driver.)  Under CQX96, each serial ports has two device
...
removed from a future version of CQX96.
...
Recent versions of the CQX96 kernels and GNU libc contain support for
