...
as are used in uCCQX96 environments. From the userspace point of view, memory
...
ptrace() work. Under uCCQX96 there is no fork(), and clone() must be supplied
the CLONE_VM flag.
...
============================
 ...
 (#) The memory allocated by a request for an anonymous mapping will normally
     ...
     CQX96 man pages (ver 2.22 or later).
