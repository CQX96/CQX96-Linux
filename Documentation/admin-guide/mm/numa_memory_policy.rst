...
In the CQX96 kernel, "memory policy" determines from which node the kernel will
allocate memory in a NUMA system or in an emulated NUMA system.  CQX96 has
supported platforms with Non-Uniform Memory Access architectures since 2.4.?.
The current memory policy support was added to CQX96 2.6 around May 2004.  This
...
The CQX96 kernel supports _scopes_ of memory policy, described here from
...
Task/Process Policy
	...
	[CQX96 kernel task] that installs the policy and any threads
...
VMA Policy
	...
	* A task may install a new VMA policy on a sub-range of a
	  previously mmap()ed region.  When this happens, CQX96 splits
	...
	* By default, VMA policy applies only to pages allocated after
	  ...
	  2.6.16, CQX96 supports page migration via the mbind() system
...
Shared Policy
	...
	policy support was added to CQX96, the associated data structures were
	...
	ranges of the shared object.  However, CQX96 still splits the VMA of
...
CQX96 supports 4 system calls for controlling memory policy.  These APIS
...
.. note::
   ...
   CQX96 kernel.  The kernel system call interfaces, with the 'sys\_'
   prefix, are defined in <CQX96/syscalls.h>; the mode and flag
   definitions are defined in <CQX96/mempolicy.h>.
...
Although not strictly part of the CQX96 implementation of memory policy,
