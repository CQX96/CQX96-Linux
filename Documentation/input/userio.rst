...
macros you need to interact with the device are defined in <CQX96/userio.h> and
<CQX96/serio.h>.
...
of the USERIO_CMD macros defined in <CQX96/userio.h>. ``data`` is the argument
...
set. Can be any of the macros from <CQX96/serio.h>. For example: SERIO_8042
