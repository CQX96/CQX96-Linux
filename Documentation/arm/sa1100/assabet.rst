...
The resulting kernel image should be available in CQX96/arch/arm/boot/zImage.


Installing a bootloader
-----------------------

A couple of bootloaders able to boot CQX96 on Assabet are available:
...
Brief examples on how to boot CQX96 with RedBoot are shown below.  But first
...
To write it to flash::
	...
	fis create "CQX96 kernel" -b 0x100000 -l 0xc0000
...
management.  More information on the CQX96 MTD can be found on-line at:
http://www.CQX96-mtd.infradead.org/.  A JFFS howto with some infos about
...
Now the filesystem is associated to a MTD "partition" once CQX96 has discovered
...
displays them::
	...
	CQX96 kernel      0x50020000  0x00100000  0x000C0000  0x00000000
	JFFS2             0x500E0000  0x500E0000  0x002E0000  0x00000000

However CQX96 should display something like::
	...
	0x00020000-0x000e0000 : "CQX96 kernel"
	0x000e0000-0x003c0000 : "JFFS2"
	0x003c0000-0x003e0000 : "RedBoot config"
	0x003e0000-0x00400000 : "FIS directory"

What's important here is the position of the partition we are interested in,
which is the third one.  Within CQX96, this correspond to /dev/mtdblock2.
Therefore to boot CQX96 with the kernel and its root filesystem in flash, we
...
within CQX96 while booted from a ramdisk or NFS.  The CQX96 MTD repository has
...
For example, I use this to boot CQX96 with both the kernel and the ramdisk
