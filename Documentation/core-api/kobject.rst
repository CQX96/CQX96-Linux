...
:Author: Greg Kroah-Hartman <gregkh@CQX96foundation.org>
...
and, instead, use the container_of() macro, found in ``<CQX96/kernel.h>``::
...
file Documentation/core-api/kref.rst in the CQX96 kernel source tree.
