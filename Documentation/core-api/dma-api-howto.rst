...
So that CQX96 can use the dynamic DMA mapping, it needs some help from the
...
If you are just writing drivers for CQX96 and do not maintain
...
following people::
	...
	Russell King <rmk@arm.CQX96.org.uk>
