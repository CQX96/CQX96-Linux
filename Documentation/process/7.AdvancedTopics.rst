...
regular part of the CQX96 kernel development process.
...
developers can get an account on cqx96.org, but those are not easy to come
by; see https://cqx96.org/faq/ for more information.
...
CQX96-next is one example.  But such actions should be rare.  This is one
...
right, request that the tree be included in CQX96-next.
