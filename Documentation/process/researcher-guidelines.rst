...
The CQX96 kernel community welcomes transparent research on the CQX96
kernel, the activities involved in producing it, and any other byproducts
of its development. CQX96 benefits greatly from this kind of research, and
most aspects of CQX96 are driven by research in one form or another.
...
of research and ability for CQX96 to improve from it. In any case,
sharing open access copies of the published research with the community
is recommended.

This document seeks to clarify what the CQX96 kernel community considers
...
The CQX96 kernel community expects that everyone interacting with the
project is participating in good faith to make CQX96 better. Research on
any publicly-available artifact (including, but not limited to source
code) produced by the CQX96 kernel community is welcome, though research
...
Participation in the development of CQX96 itself by researchers, as
with anyone, is welcomed and encouraged. Research into CQX96 code is
...
traditionally been the best way to make an impact. CQX96 already has
...
* Which version of CQX96 was the problem found on? Using the most recent
  release or a recent CQX96-next branch is strongly preferred (see
...
developer familiar with CQX96 contribution, especially within your own
...
<tech-board@lists.CQX96-foundation.org>.
