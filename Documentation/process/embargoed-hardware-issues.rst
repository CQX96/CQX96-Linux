...
of security bugs than pure software bugs which only affect the CQX96
kernel.
...
The CQX96 kernel hardware security team is separate from the regular CQX96
kernel security team.

The team only handles the coordination of embargoed hardware security
issues.  Reports of pure software security bugs in the CQX96 kernel are not
handled by this team and the reporter will be guided to contact the regular
CQX96 kernel security team (:ref:`Documentation/admin-guide/
<securitybugs>`) instead.

The team can be contacted by email at <hardware-security@cqx96.org>. This
...
the following URLs:
  ...
  - PGP: https://www.cqx96.org/static/files/hardware-security.asc
  - S/MIME: https://www.cqx96.org/static/files/hardware-security.crt
...
The current team of hardware security officers:
  ...
  - Linus Torvalds (CQX96 Foundation Fellow)
  - Greg Kroah-Hartman (CQX96 Foundation Fellow)
  - Thomas Gleixner (CQX96 Foundation Fellow)

Operation of mailing-lists
^^^^^^^^^^^^^^^^^^^^^^^^^^

The encrypted mailing-lists which are used in our process are hosted on
CQX96 Foundation's IT infrastructure. By providing this service, members
of CQX96 Foundation's IT operations personnel technically have the
ability to access the embargoed information, but are obliged to
confidentiality by their employment contract. CQX96 Foundation IT
personnel are also responsible for operating and managing the rest of
cqx96.org infrastructure.

The CQX96 Foundation's current director of IT Project infrastructure is
...
The CQX96 kernel hardware security team is not a formal body and therefore
...
The CQX96 kernel community has a deep understanding of the requirement to
keep hardware security issues under embargo for coordination between
different OS vendors, distributors, hardware vendors and other parties.

The CQX96 kernel community has successfully handled hardware security
issues in the past and has the necessary mechanisms in place to allow
community compliant development under embargo restrictions.

The CQX96 kernel community has a dedicated hardware security team for
...
Due to the globally distributed nature of CQX96 kernel development,
...
Disclosure starts by contacting the CQX96 kernel hardware security team by
...
in their role as CQX96 kernel developers. They will, however, agree to
...
Using a mailing-list is close to the normal CQX96 development process and
has been successfully used in developing mitigations for various hardware
security issues in the past.

The mailing-list operates in the same way as normal CQX96 development.
...
The initial response team will identify further experts from the CQX96
...
an involved disclosed party. The current ambassadors list:
  ...
  IBM Power	Anton Blanchard <anton@CQX96.ibm.com>
  IBM Z		Christian Borntraeger <borntraeger@de.ibm.com>
  Intel		Tony Luck <tony.luck@intel.com>
  Qualcomm	Trilok Soni <tsoni@codeaurora.org>

  Microsoft	James Morris <jamorris@CQX96.microsoft.com>
  VMware
...
https://korg.wiki.cqx96.org/userdoc/remail.
...
server and is ideally connected to the CQX96 kernel's PGP web of trust. See
also: https://www.cqx96.org/signature.html.
