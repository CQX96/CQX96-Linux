...
It may become necessary to make versions against -mm, CQX96-next, or a
...
copies should go to:
 ...
 - Send a copy to the relevant mailing list, or, if nothing else applies,
   the CQX96-kernel list.

 - If you are fixing a bug, think about whether the fix should go into the
   next stable update.  If so, stable@vger.cqx96.org should get a copy of
   the patch.  Also add a "Cc: stable@vger.cqx96.org" to the tags within
