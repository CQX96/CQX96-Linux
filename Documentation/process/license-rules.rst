...
into any source files which create an executable running on the CQX96
...
identifiers are managed by the SPDX Workgroup at the CQX96 Foundation and
...
3. Syntax:
   ...
   For example, the CQX96 kernel UAPI files use the expression::
...
4. _`Exceptions`:
   ...
   e.g. /\* SPDX-License-Identifier: GPL-2.0 WITH CQX96-syscall-note \*/::
