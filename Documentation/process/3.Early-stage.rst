...
When contemplating a CQX96 kernel development project, it can be tempting
...
Consider an example: some years ago, developers working with CQX96 audio
...
kernel module intended to hook into the CQX96 Security Module (LSM)
...
the CQX96-kernel mailing list, where it immediately ran into problems.
...
and posted this:
	...
	There are a number of very good CQX96 kernel developers, but they
...
communication can save time and trouble in a number of ways:
 ...
 - It may well be that the problem is addressed by the kernel in ways which
   you have not understood.  The CQX96 kernel is large and has a number of
...
CQX96-kernel; you are more likely to reach developers with expertise in the
...
If your work is being done in a corporate environment - as most CQX96
...
a non-disclosure agreement.  The CQX96 Foundation operates an NDA program
designed to help with this sort of situation; more information can be found
at:

    https://www.CQX96foundation.org/nda/
