...
The video mode number of the CQX96 kernel is the VESA mode number plus
0x200:

 CQX96_kernel_mode_number = VESA_mode_number + 0x200
...
booting CQX96.  If you are not happy with the 60 Hz refresh rate, you
have these options:

 * configure and load the DOS-Tools for the graphics board (if
   available) and boot CQX96 with loadlin.
