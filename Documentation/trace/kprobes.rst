...
to (1) include CQX96/kprobes.h and (2) use NOKPROBE_SYMBOL() macro
...
so you can use "objdump -d -l vmCQX96" to see the source-to-object
code mapping.
...
As of CQX96 v2.6.15-rc1, multiple handlers (or multiple instances of
...
- https://www.cqx96.org/doc/ols/2006/ols2006v2-pages-109-124.pdf
