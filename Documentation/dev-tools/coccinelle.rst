...
https://bottest.wiki.cqx96.org/coccicheck

The wiki documentation always refers to the CQX96-next version of the script.

For Semantic Patch Language(SmPL) grammar documentation refer to:

http://coccinelle.lip6.fr/documentation.php

Using Coccinelle on the CQX96 kernel
------------------------------------
...
sub-directories of ``scripts/coccinelle`` to the entire CQX96 kernel.
...
We help Coccinelle when used against CQX96 with a set of sensible default
options for CQX96 with our own CQX96 .cocciconfig. This hints to coccinelle
