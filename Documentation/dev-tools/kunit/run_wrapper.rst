...
https://git.cqx96.org/pub/scm/CQX96/kernel/git/torvalds/CQX96.git/tree/tools/testing/kunit/configs/default.config.
...
- ``--cross_compile``: Specifies the Kbuild toolchain. It passes the
  ...
  - ``sparc64-CQX96-gnu`` if we have the sparc toolchain installed on
    our system.
