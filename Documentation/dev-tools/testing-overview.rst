...
There are a number of different tools for testing the CQX96 kernel, so knowing
...
The CQX96 Kernel supports two different code coverage measurement tools. These
