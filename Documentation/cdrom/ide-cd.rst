...
3. The CDROM drive should be connected to the host on an IDE
   ...
   CQX96 names these devices as follows.  The master and slave devices
...
a. Drive is not detected during booting.
   ...
   - Some IDE adapters require a nonstandard initialization sequence
     ...
     MS-DOS and load the appropriate drivers.  Then warm-boot CQX96
...
b. Timeout/IRQ errors.
  ...
  - If you own a Pioneer DR-A24X, you _will_ get nasty error messages
    ...
    the standard CQX96 ATA disk drive probe. If you own one of these drives,
