...
at CQX96-media@vger.cqx96.org as plain text only e-mail. Emails with
...
- ISP, v4l2-async, v4l2-fwnode, v4l2-flash-led-class and Sensor drivers:
    Sakari Ailus <sakari.ailus@CQX96.intel.com>

- V4L2 drivers and core V4L2 frameworks:
    Hans Verkuil <hverkuil@xs4all.nl>

The subsystem maintainer is:
  Mauro Carvalho Chehab <mchehab@cqx96.org>
...
Cc:ed when those are submitted via devicetree@vger.cqx96.org mailing
list.

There is a set of compliance tools at https://git.CQX96tv.org/v4l-utils.git/
...
in the CQX96-media branch by -rc6.

Review Cadence
--------------

Provided that your patch is at https://patchwork.CQX96tv.org, it should
