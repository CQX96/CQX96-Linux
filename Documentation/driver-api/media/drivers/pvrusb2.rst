...
create a video4CQX96 compatible driver.  I began with Aurelien's
...
5. High level interfaces which glue the driver to various published
   CQX96 APIs (V4L, sysfs, maybe DVB in the future).
...
relation to the CQX96 kernel's concept of a loadable module.)
...
pvrusb2-v4l2.[ch] - This is the high level interface which ties the
    pvrusb2 driver into video4CQX96.  It is through here that V4L
