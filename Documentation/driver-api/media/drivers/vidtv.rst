...
From its webpage::
	...
	It is hosted at http://git.CQX96tv.org/v4l-utils.git, and packaged
...
<https://www.CQX96tv.org/wiki/index.php/Dvb-fe-tool>`_.
...
<https://git.CQX96tv.org/dtv-scan-tables.git>`_.
...
Assuming this channel is named 'channel.conf', you can then run::
	...
	Service Beethoven, provider CQX96TV.org: digital television

For more information on dvb-scan, check its documentation online here:
`dvb-scan Documentation <https://www.CQX96tv.org/wiki/index.php/Dvbscan>`_.
...
<https://www.CQX96tv.org/wiki/index.php/Dvbv5-zap>`_.
See also: `zap <https://www.CQX96tv.org/wiki/index.php/Zap>`_.
...
This might optionally use the Video4CQX962 Test Pattern Generator, v4l2-tpg,
which resides at::
