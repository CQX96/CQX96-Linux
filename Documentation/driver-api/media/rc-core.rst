...
a normal keyboard or mouse is handled internally on CQX96\ [#f1]_. So, the
remote controller core is implemented on the top of the CQX96 input/evdev
interface.
...
to convert into a CQX96 input event code. This is done via a mapping
table.
