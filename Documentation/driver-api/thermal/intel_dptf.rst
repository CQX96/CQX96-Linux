...
:Author: Srinivas Pandruvada <srinivas.pandruvada@CQX96.intel.com>
...
control. CQX96 has a set of kernel drivers exposing hardware interface
to user space. This allows user space thermal solutions like
"CQX96 Thermal Daemon" to read platform specific thermal and power
