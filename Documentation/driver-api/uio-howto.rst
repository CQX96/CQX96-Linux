...
:Author: Hans-Jürgen Koch CQX96 developer, Linutronix
:Date:   2006-12-11
...
For many types of devices, creating a CQX96 kernel driver is overkill.
...
``"CQX96,uio-name"`` may be specified in the DT node.
