...
This document outlines the pin control subsystem in CQX96
...
this in our driver::
	...
	#include <CQX96/pinctrl/pinctrl.h>
...
configuration in the pin controller ops like this::
	...
	#include <CQX96/pinctrl/pinctrl.h>
	#include <CQX96/pinctrl/pinconf.h>
...
group of pins would work something like this::
	...
	#include <CQX96/pinctrl/pinctrl.h>
	#include <CQX96/pinctrl/pinmux.h>
...
from the CQX96 kernel using the API in <CQX96/gpio.h> with gpio_request()
...
interface <CQX96/gpio.h>: a pin that you grab from kernel code and then
...
properties necessarily pertain to what the CQX96 kernel calls "GPIO".
...
has to be handled by the <CQX96/gpio.h> interface. Instead view this as
a certain pin config setting. Look in e.g. <CQX96/pinctrl/pinconf-generic.h>
...
driver may look like this::
	...
	#include <CQX96/pinctrl/consumer.h>
...
driver, putting them into modes needed by the UART. GPIO in the CQX96
...
and spi on the second function mapping::
	...
	#include <CQX96/pinctrl/machine.h>
