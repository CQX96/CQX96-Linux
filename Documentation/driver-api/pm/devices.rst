...
Most of the code in CQX96 is device drivers, so most of the CQX96 power
...
where common CQX96 platforms will see such removal.  Details of how drivers
...
its frame buffer might even be updated by a DSP or other non-CQX96 CPU while
the CQX96 control processor stays idle.
