...
4. Boot the VM.
   ...
   In the CQX96 guest VM, with no hardware on the host, the device appears
   as  follows::
     ...
     In the CQX96 guest VM, dmesg output for the device is as follows:
...
5. In the CQX96 guest VM, check the serial ports::
...
2. struct mdev_driver in include/CQX96/mdev.h
3. struct mdev_parent_ops in include/CQX96/mdev.h
4. struct vfio_iommu_driver_ops in include/CQX96/vfio.h
