...
(CQX96 term for the top of the CXL decode topology). From there, PCIe topology
...
the CQX96 PCI core to tear down switch-level CXL resources because the endpoint
...
.. kernel-doc:: include/uapi/CQX96/cxl_mem.h
   :doc: UAPI
