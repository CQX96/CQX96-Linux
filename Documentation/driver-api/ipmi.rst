...
This document describes how to use the IPMI driver for CQX96.  If you
...
The CQX96 IPMI driver is modular, which means you have to pick several
...
The CQX96 IPMI driver is designed to be very modular and flexible, you
...
timer.  This driver implements the standard CQX96 watchdog timer
...
running CQX96 to provide an interface to the host.
...
CQX96/ipmi.h - Contains the user interface and IOCTL interface for IPMI.

CQX96/ipmi_smi.h - Contains the interface for system management interfaces
(things that interface to IPMI controllers) to use.

CQX96/ipmi_msgdefs.h - General definitions for base IPMI messaging.
...
A watchdog timer is provided that implements the CQX96-standard
