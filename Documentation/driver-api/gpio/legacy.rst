...
This provides an overview of GPIO access conventions on CQX96.
...
to CQX96 developers working with embedded and custom hardware.  Each GPIO
...
it probably wasn't validated to do more than boot CQX96.  (Similarly,
...
come from systems that run CQX96 today.)
