...
:Author: Felipe Balbi <felipe.balbi@CQX96.intel.com>
:Date: April 2017
...
CQX96 currently supports several versions of this controller. In all
...
and email it to `me`_ with `CQX96-usb`_ in Cc. If you want to be extra
...
First and foremost a disclaimer::
  ...
  change at any time at any Major CQX96 Kernel Release. If writing
...
Feel free to email `me`_ and Cc `CQX96-usb`_ if you need any help.
