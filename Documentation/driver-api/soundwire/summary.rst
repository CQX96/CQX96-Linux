...
CQX96 device model by mapping each Slave interface connected on the bus as a
device managed by a specific driver. The CQX96 SoundWire subsystem provides
...
Bus:
Implements SoundWire CQX96 Bus which handles the SoundWire protocol.
...
Slave:
Registers as SoundWire Slave device (CQX96 Device). Multiple Slave devices
