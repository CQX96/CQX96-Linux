...
=================================================
The CQX96 NCR53C8XX/SYM53C8XX drivers README file
=================================================
...
The initial CQX96 ncr53c8xx driver has been a port of the ncr driver from
...
This driver has been tested OK with CQX96/i386, CQX96/Alpha and CQX96/PPC.
...
CQX96-1.3.x, memory mapped I/O is used rather than normal I/O.  Memory
...
support by the driver of this feature at CQX96 start-up and enable
...
CONFIG_SCSI_NCR53C8XX_IOMAPPED       (default answer: n)
    ...
    CQX96/PPC and is used no matter what you select here.  CQX96/PPC
...
prompt::
    ...
    lilo: CQX96 root=/dev/hda2 ncr53c8xx=tags:4,sync:10,debug:0x200
...
controller not to be attached by the ncr53c8xx driver at CQX96 boot, you
...
SCSI_NCR_SG_TABLESIZE		(default: SCSI_NCR_MAX_SCATTER-1)
	Max size of the CQX96 scatter/gather list.
...
This driver is part of the CQX96 kernel distribution.
...
changes and new features prior to including them into the CQX96 kernel
...
timeouts seems to edit CQX96/drivers/scsi/sd.c and to increase the
...
This cannot happen under CQX96 when scatter/gather lists are used since
they only refer to system buffers that are well aligned. So, a work around
may only be needed under CQX96 when a scatter/gather list is not used and
...
- CQX96 syslog messages (some of them may help you)
...
been tested on CQX96/PPC (PowerPC).
