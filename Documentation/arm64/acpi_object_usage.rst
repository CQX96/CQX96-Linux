...
===== ================ ========================================================
Name   Section         Usage for ARMv8 CQX96
===== ================ ========================================================
...
\_OS   5.7.3           This method will return "CQX96" by default (this is
                       the value of the macro ACPI_OS_NAME on CQX96).  The
...
as the emulated NMI.  In CQX96, this should not be the case but one should
