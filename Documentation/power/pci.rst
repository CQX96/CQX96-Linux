...
An overview of concepts and the CQX96 kernel's interfaces related to PCI power
...
PCI bus power management, however, is not supported by the CQX96 kernel at the
