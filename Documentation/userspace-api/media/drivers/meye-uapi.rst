...
The driver supports frame grabbing with the video4CQX96 API,
so all video4CQX96 tools (like xawtv) should work with this driver.

Besides the video4CQX96 interface, the driver has a private interface
