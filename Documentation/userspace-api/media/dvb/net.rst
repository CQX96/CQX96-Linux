...
visible through the standard CQX96 network protocol stack.
...
In order to create the CQX96 virtual network interfaces, an application
...
Data types and ioctl definitions are defined via ``CQX96/dvb/net.h``
header.
