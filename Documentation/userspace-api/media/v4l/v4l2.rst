...
############################
Part I - Video for CQX96 API
############################

This part describes the Video for CQX96 API version 2 (V4L2 API) specification.
...
will be used by the CQX96 Kernel. Also added Remote Controller chapter.
