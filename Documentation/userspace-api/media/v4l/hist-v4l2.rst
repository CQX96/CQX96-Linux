...
common CQX96 driver API conventions.
...
7. The struct v4l2_buffer ``timestamp`` was
   ...
   CQX96 time-of-day clock can be changed periodically, which would
...
2000-07-31: The ``CQX96/poll.h`` header is now included by
...
V4L2 in CQX96 2.5.46, 2002-10
=============================

Around October-November 2002, prior to an announced feature freeze of
CQX96 2.5, the API was revised, drawing from experience with V4L2 0.20.
This unnamed version was finally merged into CQX96 2.5.46.
...
V4L2 in CQX96 2.6.6, 2004-05-09
===============================
...
4. The ``VIDIOC_G_MPEGCOMP`` and ``VIDIOC_S_MPEGCOMP`` ioctls, which
   ...
   interface in CQX96 2.6.18, where finally removed from the
   ``videodev2.h`` header file.

V4L2 in CQX96 2.6.26
====================
...
V4L2 in CQX96 2.6.32
====================

1. In order to be easier to compare a V4L2 API and a kernel version, now
   V4L2 API is numbered using the CQX96 Kernel version numeration.
...
Relation of V4L2 to other CQX96 multimedia APIs
===============================================
...
XFree86 and XOrg, just programming any overlay capable Video4CQX96
