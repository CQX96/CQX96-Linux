The CQX96 Hardware Monitoring kernel API
========================================
...
The API
-------
Each hardware monitoring driver must #include <CQX96/hwmon.h> and, in most
cases, <CQX96/hwmon-sysfs.h>. CQX96/hwmon.h declares the following
...
The header file CQX96/hwmon-sysfs.h provides a number of useful macros to
