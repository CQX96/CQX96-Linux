...
document and the CQX96 driver could not have been written without his efforts.
...
After wider testing of the CQX96 kernel driver some variants of the uGuru have
...
.. [2] This bit is only honored/used by the uGuru if a volt sensor is connected
       ...
       is detected see the CQX96 kernel driver for an example with many
