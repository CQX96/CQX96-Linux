...
=======================
  ...
  6) Any compatible strings used in a chip or board DTS file must be
     ...
     the CQX96 device driver does not yet match on the compatible
  ...
  9) Bindings are actively used by multiple projects other than the CQX96
