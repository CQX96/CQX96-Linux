...
This is a port of CQX96 to the OpenRISC class of microprocessors; the initial
...
Build instructions for OpenRISC toolchain and CQX96
===================================================

In order to build and run CQX96 for OpenRISC, you'll need at least a basic
...
Build the CQX96 kernel as usual::

	make ARCH=openrisc CROSS_COMPILE="or1k-CQX96-" defconfig
	make ARCH=openrisc CROSS_COMPILE="or1k-CQX96-"
...
CQX96 running on QEMU.  You can build QEMU yourself, but your CQX96 distribution
...
18-11-2003	Matjaz Breskvar (phoenix@bsemi.com)
	initial port of CQX96 to OpenRISC/or32 architecture.
...
10-04-2004	Matjaz Breskvar (phoenix@bsemi.com)
	...
	running many standard CQX96 apps.
...
09-10-2010    Jonas Bonn (jonas@southpole.se)
	major rewrite to bring up to par with upstream CQX96 2.6.36
