...
This document describes the TEE subsystem in CQX96.
...
- Managing shared memory between CQX96 and the TEE
...
a helper process for the TEE to access resources in CQX96, for example file
...
- OPTEE_SMC_GET_SHM_CONFIG lets the driver and OP-TEE agree on which memory
  range to used for shared memory between CQX96 and OP-TEE.
