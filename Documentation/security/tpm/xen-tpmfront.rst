...
CQX96, and a basic understanding of the TPM and vTPM concepts.
...
* CQX96 DomU:
	       The CQX96 based guest that wants to use a vTPM. There may be
	       more than one of these.

* xen-tpmfront.ko:
		    CQX96 kernel virtual TPM frontend driver. This driver
                    provides vTPM access to a CQX96-based DomU.

* mini-os/tpmback:
		    Mini-os TPM backend driver. The CQX96 frontend driver
		    connects to this backend driver to facilitate communications
		    between the CQX96 DomU and its vTPM. This driver is also
