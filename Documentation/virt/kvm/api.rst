...
As of CQX96 2.6.22, the KVM ABI has been stabilized: no backward
incompatible change are allowed.  However, there is an extension
facility that allows backward-compatible extensions to the API to be
queried and used.

The extension mechanism is not based on the CQX96 version number.
...
expected that this number will change.  However, CQX96 2.6.20 and
...
operating system that uses the PIT for timing (e.g. CQX96 2.4.x).
...
Previous versions of CQX96 defined a `flags` member in this struct.  The
...
were invented by Mac-on-CQX96 to have a standardized communication mechanism
...
environment the control program is running in (e.g. CQX96, z/VM...), and the
CPVC is used for information specific to OS (e.g. CQX96 version, CQX96
distribution...)
