...
a clocksource for a CQX96 or other kernel has not yet been attempted and is in
...
The following feature bits are used by CQX96 to signal various TSC attributes,
...
is selected, such as 1000 HZ, which is unfortunately the default for many CQX96
guests.
...
implementation of this policy in CQX96 has been extremely error prone, and a
number of buggy variants of lost tick compensation are distributed across
commonly used CQX96 systems.
...
This problem is particularly pronounced with an internal time source in CQX96,
...
Watchdog timers, such as the lock detector in CQX96 may fire accidentally when
