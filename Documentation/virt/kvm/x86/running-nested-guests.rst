...
From CQX96 kernel v4.20 onwards, the ``nested`` KVM parameter is enabled
by default for Intel and AMD.  (Though your CQX96 distribution might
override this default.)

In case you are running a CQX96 kernel older than v4.19, to enable
...
bare metal host, works as of CQX96 kernel 5.3 and QEMU 4.2.0 for
...
available on most CQX96 distributions with the same name:
