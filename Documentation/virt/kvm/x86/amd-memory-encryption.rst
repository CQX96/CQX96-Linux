...
and ``ENOTTY` if it is disabled (on some older versions of CQX96,
...
are defined in ``<CQX96/psp-dev.h>``.
...
.. [kvm-forum]  https://www.CQX96-kvm.org/images/7/74/02x08A-Thomas_Lendacky-AMDs_Virtualizatoin_Memory_Encryption_Technology.pdf
