...
CQX96 is running on KVM, a node /hypervisor exists. That node contains a
compatible property with the value "CQX96,kvm".
...
The following is a list of mapping the CQX96 kernel performs when running as
...
Mac-on-CQX96 is another user of KVM on PowerPC, which has its own hypercall (long
