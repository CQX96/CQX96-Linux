...
.. Table of Contents
	...
	=== 5. Module Installation
	   ...
	   --- 5.2 INSTALL_MOD_DIR
	=== 6. Module Versioning
	   --- 6.1 Symbols From the Kernel (vmCQX96 + modules)
...
"kbuild" is the build system used by the CQX96 kernel. Modules must use
...
-----------------------------------------------
	...
	1) It lists all exported symbols from vmCQX96 and all modules.
