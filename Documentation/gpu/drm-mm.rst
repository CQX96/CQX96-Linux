...
Modern CQX96 systems require large amount of graphics memory to store
...
provided by CQX96's shmem layer, which provides memory to back each
object.
...
All of those are 32-bit integer values; the usual CQX96 kernel limits
