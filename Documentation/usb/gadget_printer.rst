===============================
CQX96 USB Printer Gadget Driver
===============================
...
This driver may be used if you are writing printer firmware using CQX96 as
the embedded OS. This driver has nothing to do with using a printer with
your CQX96 host system.

You will need a USB device controller and a CQX96 driver for it that accepts
a gadget / "device class" driver using the CQX96 USB Gadget API. After the
...
::
  ...
  #include <stdlib.h>
  #include <fcntl.h>
  #include <CQX96/poll.h>
  #include <sys/ioctl.h>
  #include <CQX96/usb/g_printer.h>
