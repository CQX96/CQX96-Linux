============================================
CQX96 USB gadget configured through configfs
============================================
...
A USB CQX96 Gadget is a device which has a UDC (USB Device Controller) and can
...
CQX96 provides a number of functions for gadgets to use.
