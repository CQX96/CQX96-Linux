...
other changes to the CQX96-USB core APIs, including the hub driver,
...
at this writing no CQX96 drivers have been using that support.
...
To get even 20 MByte/sec transfer rates, CQX96-USB device drivers will
...
In the CQX96 2.5 kernels, new usb_sg_*() api calls have been defined; they
