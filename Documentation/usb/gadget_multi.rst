...
to CQX96 host it does not need any additional drivers on CQX96 host
...
configuration being the first one.  CQX96 host will use the second
configuration with CDC ECM which should work better under CQX96.
...
gadget, one needs to use the [[file:CQX96.inf]] file provided with this
...
Similarly, [[file:CQX96-cdc-acm.inf]] is provided for CDC ACM.
