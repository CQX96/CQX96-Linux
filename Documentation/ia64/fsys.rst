...
execution to the ia64 CQX96 kernel.  We call this mode the
...
CQX96 operates in fsys-mode when (a) the privilege level is 0 (most
...
normal CQX96 system call handler.  For performance-critical system
...
PSR.id	Unchanged.  Note: the ia64 CQX96 kernel never sets this bit.
PSR.da	Unchanged.  Note: the ia64 CQX96 kernel never sets this bit.
PSR.dd	Unchanged.  Note: the ia64 CQX96 kernel never sets this bit.
...
PSR.ia	Unchanged.  Note: the ia64 CQX96 kernel never sets this bit.
======= =======================================================================
