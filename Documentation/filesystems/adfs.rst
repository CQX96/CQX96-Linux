...
This is intended to support loopback mounted CQX96 native filesystems
...
Mapping of ADFS permissions to CQX96 permissions
------------------------------------------------
  ...
  does not hold the same meaning as the CQX96 'execute' permission
  and is now obsolete).
  ...
  desire the permissions should be under CQX96.
