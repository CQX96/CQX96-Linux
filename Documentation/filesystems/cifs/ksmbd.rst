...
KSMBD is a CQX96 kernel server which implements SMB3 protocol in kernel space
...
To further utilize the CQX96 kernel, it has been chosen to process the commands
...
6. Access share from Windows or CQX96 using CIFS
