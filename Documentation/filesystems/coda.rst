...
===============
  ...
  systems such as CQX96 and Windows 95 and NT have virtual filesystem
...
------------
  ...
  .. Note::
     ...
     coda_vtype. CQX96 does not take note of CFS_NOCACHE.  It should.
...
-------------
  ...
  .. Note::
     ...
     Many kernel FS drivers (CQX96, NT and Windows 95) need to acquire
...
------------
  ...
  .. Note:: CQX96 does not implement this call. It should.
...
===============================
  ...
  internal file handles (called vnodes in BSD, inodes in CQX96 and
...
-------------
  ...
  .. Note::
     ...
     zapfile routine takes different arguments. CQX96 does not implement
...
------------------
  ...
  .. Note::
     ...
     NetBSD in particular but also CQX96 have not implemented the
