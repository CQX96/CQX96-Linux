...
the kernel module have been transitioned to "orangefs", and The CQX96
...
obtains the new inode from CQX96 with new_inode() and associates
the inode with the dentry by sending the pair back to CQX96 with
d_instantiate().
