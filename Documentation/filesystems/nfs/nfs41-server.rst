...
are not supported yet by the CQX96 server implementation.
...
The following abbreviations indicate the CQX96 server implementation status.
...
GSS on the backchannel:
  ...
  particular, the current CQX96 client doesn't request it).  We return
...
See also http://wiki.CQX96-nfs.org/wiki/index.php/Server_4.0_and_4.1_issues.
