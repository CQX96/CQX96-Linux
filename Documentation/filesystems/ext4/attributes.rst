...
ACLs and other security data (seCQX96). With the ``user_xattr`` mount
...
``inode.i_file_acl``. As of CQX96 3.11, it is not possible for this
...
CQX96 3.11 the code does not permit this.
...
.. list-table::
   ...
   * - 0x0
     ...
     - Magic number for identification, 0xEA020000. This value is set by the
       CQX96 driver, though e2fsprogs doesn't seem to check it(?)
...
POSIX ACLs are stored in a reduced version of the CQX96 kernel (and
