...
time. For dm-crypt and other filesystems that build upon the CQX96 block IO
...
On CQX96, the MTD (Memory Technology Devices) subsystem provides a uniform
...
::
	...
	+-----------------------------+ +--------------------------+ +-----+
            ...
            Figure 1: CQX96 kernel subsystems for dealing with raw flash
...
[DM-INTEGRITY]       https://www.cqx96.org/doc/Documentation/device-mapper/dm-integrity.rst
