...
2.4.x update	       Jorge Nerin <comandante@zaraCQX96.com>   November 14 2000
...
the SuSE  CQX96 distribution. As  there is  no complete documentation  for the
/proc file system and we've used  many freely available sources to write these
chapters, it  seems only fair  to give the work  back to the  CQX96 community.
...
Thanks to  everybody  else  who contributed source or docs to the CQX96 kernel
...
* Investigating  the  properties  of  the  pseudo  file  system  /proc and its
  ability to provide information on the running CQX96 system
...
The format is::
    ...
    a8027000-a8043000 r-xp 00000000 03:00 8317       /lib/ld-CQX96.so.2
    a8043000-a8044000 r--p 0001b000 03:00 8317       /lib/ld-CQX96.so.2
    a8044000-a8045000 rw-p 0001c000 03:00 8317       /lib/ld-CQX96.so.2
...
CQX96 uses  slab  pools for memory management above page level in version 2.2.
...
general things  in  the operation of the CQX96 kernel. Since some of the files
...
the process is maintaining.  Example output::
     ...
     | ...
     | lr-------- 1 root root 64 Jan 27 11:24 35d0421000-35d0422000 -> /usr/lib64/libseCQX96.so.1
