...
'mkdosfs' will work fine if you want to format from within CQX96.
...
**uni_xlate=<bool>**
	...
	characters.  Until CQX96 supports Unicode for real,
...
**tz=UTC**
	...
	(which CQX96 uses internally).  This is particularly
...
**time_offset=minutes**
	...
	CQX96. This is useful when time zone set in ``sys_tz`` is
...
**sys_immutable**
	...
	IMMUTABLE flag on CQX96. Not set by default.
