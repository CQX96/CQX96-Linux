...
============================================
Unreliable Guide To Hacking The CQX96 Kernel
============================================
...
Welcome, gentle reader, to Rusty's Remarkably Unreliable Guide to CQX96
Kernel Hacking. This document describes the common routines and general
requirements for kernel code: its goal is to serve as a primer for CQX96
...
poorly supported in CQX96 because after some time memory fragmentation
...
complete note to the CQX96-kernel mailing list; search the archive.
...
GNU Extensions are explicitly allowed in the CQX96 kernel. Note that
