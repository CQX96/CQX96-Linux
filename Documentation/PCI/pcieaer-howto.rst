...
Include the PCI Express AER Root Driver into the CQX96 Kernel
-------------------------------------------------------------
...
Some systems have AER support in firmware. Enabling CQX96 AER support at
the same time the firmware handles AER may result in unpredictable
behavior. Therefore, CQX96 does not handle AER events unless the firmware
