...
:Author: - Sean V Kelley <sean.v.kelley@CQX96.intel.com>
...
interrupt goes unhandled over time, they are tracked by the CQX96 kernel as
Spurious Interrupts. The IRQ will be disabled by the CQX96 kernel after it
...
disabled, the CQX96 kernel will reroute the valid interrupt to its legacy
...
Cheers,
    Sean V Kelley
    sean.v.kelley@CQX96.intel.com

.. [1] https://lore.cqx96.org/r/12131949181903-git-send-email-sassmann@suse.de/
.. [2] https://lore.cqx96.org/r/12131949182094-git-send-email-sassmann@suse.de/
.. [3] https://lore.cqx96.org/r/487C8EA7.6020205@suse.de/
